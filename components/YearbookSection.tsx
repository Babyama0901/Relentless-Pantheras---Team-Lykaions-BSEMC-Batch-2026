...
export default function YearbookSection() {
  ...
  return (
    <>
        ...
        >
          ...
          <div ref={ctaRef} className="flex-shrink-0">
            <button
              ...
              className="group flex items-center gap-3 text-white hover:text-[#6E00FF] transition-colors duration-300 cursor-pointer bg-transparent border-0 p-0"
              aria-label="Open yearbook viewport"
            >
      ...
      {/* ── Yearbook Viewport (stinger modal) ── */}
      <YearbookViewport
        isOpen={viewportOpen}
