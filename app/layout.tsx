...
import { formula1, arame, trap, aboveBeyond } from "./fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`dark ${formula1.variable} ${arame.variable} ${trap.variable} ${aboveBeyond.variable} selection:bg-[#6E00FF] selection:text-white`}>
