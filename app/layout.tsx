...
import { formula1, arame, trap, script } from "./fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`dark ${formula1.variable} ${arame.variable} ${trap.variable} ${script.variable} selection:bg-[#6E00FF] selection:text-white`}>
